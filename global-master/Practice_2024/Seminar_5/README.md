...
1. Создать таблицу и заполнить ее данными согласно [скрипту](sem_5_isnerts.sql). 

2. Вывести все товары и среднюю цену товара в каждой из категорий в отдельном столбце.
...
7.  Вычислить накопительную сумму цен продуктов в каждой группе на основе цены.

8.  


9. Найти самый дешевый продукт в каждой группе и сопоставить его цену с ценами других продуктов.

10. Анализ изменений цен продуктов в последовательности

11. Создайте запрос, который анализирует тренд изменения цен для каждого продукта в группе и определяет, увеличивается ли цена, уменьшается, или остается неизменной, сравнивая с предыдущей ценой.

12. Для каждого продукта в группе вычислите отклонение от средней цены продуктов в этой группе при помощи оконных функций.

13. Используя функции LAG, LEAD, создайте запрос, который определяет, является ли цена продукта минимальной, максимальной, или промежуточной в группе.

14. Используйте LEAD для предсказания следующей возможной цены продукта и создайте анализ, который сравнивает фактическую следующую цену с рассчитанным прогнозом по линейному тренду (используйте упрощенный тренд).
